...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dog_image: ImageView = view!!.findViewById(R.id.iv_dog_picture)
        val dog_name: TextView = view!!.findViewById(R.id.tv_name)
        val dog_age: TextView = view!!.findViewById(R.id.tv_age)
        val dog_hobbies: TextView = view!!.findViewById(R.id.tv_hobbies)
    }
